  ...
  return (
    <div className="flex flex-col items-center px-4 animate-fadeIn">
      <div className="mt-28 text-center transition-all duration-500">
        <h1 className="text-4xl sm:text-6xl md:text-8xl font-extrabold tracking-wider drop-shadow-lg text-[var(--color-primary)]/90">
          Nutcha Bites
        </h1>
        <p className="text-base sm:text-lg md:text-xl font-light mt-4 drop-shadow-sm text-[var(--color-primary)]/70">
